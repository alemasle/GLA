...
public class JeuDeTestJdBc {
	...
	public final static String[] QUERIES = { "drop table if exists Messages", "drop table if exists Threads",
			...
			"create table Utilisateurs (id integer primary key, login varchar(255), password varchar(255), posts integer default 0)",
			...
			"INSERT INTO THREADS(auteur, name) VALUES(3, 'Mon second suis le premier')",
			"INSERT INTO THREADS(auteur, name) VALUES(2, 'Mon tout est une mauvaise charade')",

			"INSERT INTO MESSAGES(auteur, idThread, texte, date) VALUES(0, 1, 'First!', '00:11:03 10/10/2018')", };
