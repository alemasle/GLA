...
public class JeuDeTestJdBc {
	...
	public final static String[] QUERIES = {
			...
			"create table Threads (id bigint not null, auteur bigint not null, name varchar(255), primary key (id), constraint fk_thread_auteur foreign key (auteur) references Utilisateurs(id))",
			...
			"INSERT INTO THREADS VALUES(1, 1, 'Mon premier thread est nul et sans interet')",
